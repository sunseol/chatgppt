...
describe("live usage summary image usage evidence", () => {
  ...
  test("blocks confirmation filenames that are not bound to a project and job", () => {
    // Given
    const stages: readonly LiveUsageStageSummary[] = [
      {
        stageId: "generate",
  ...
  test("blocks fallback unknown confirmation evidence path segments", () => {
    // Given
    const stages: readonly LiveUsageStageSummary[] = [
      {
        stageId: "generate",
        ...
        imageBillingDisclosure: {
          ...
          userConfirmed: true,
          label: "Codex image usage confirmed",
          confirmationEvidencePath: "usage/unknown/unknown/image-billing-confirmation.json",
        },
      },
    ];
