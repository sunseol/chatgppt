...
describe("live interruption evidence identity", () => {
  test("blocks interruption evidence identities that only become canonical after trimming", () => {
    // Given
      ...
      scenarios: LIVE_INTERRUPTION_SCENARIOS.map((id) =>
        id === "cancel_job"
          ? scenario(id, {
              ...
              recoverySnapshotPath: " recovery/cancel_job.json ",
