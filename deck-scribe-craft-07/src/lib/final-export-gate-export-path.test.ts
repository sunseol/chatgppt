...
describe("final export gate export paths", () => {
  test("blocks production export package paths that point at observer templates", () => {
    // Given
    ...
    const result = evaluateFinalExportGate({
      ...
      exportPackage: {
        ...
        artifactPath: "projects/project_001/exports/template/export.v1.json",
        projectFilePath: "projects/project_001/exports/sample/project_001.deckforge.json",
      },
