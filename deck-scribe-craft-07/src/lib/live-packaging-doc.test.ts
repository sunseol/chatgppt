...
const CURRENT_DRY_RUN_SHA = "1637677e8dfff5f8c0629a8c5c8d72c1c0684185aaf809cc0c0ade37a234de24";
...
describe("live packaging documentation", () => {
  test("records the current DF-245 dry-run package scan evidence", () => {
    ...
    expect(runbook.includes("284,501 bytes compressed")).toBe(true);
    ...
    expect(decision.includes("830 tests")).toBe(true);
  });
});
