...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DeckForge" },
      { name: "description", content: "데스크탑 슬라이드 제작 앱" },
      { name: "author", content: "DeckForge" },
      { property: "og:title", content: "DeckForge" },
      { property: "og:description", content: "데스크탑 슬라이드 제작 앱" },
