...
- nonblank source ids used by the slide, with no blank source id entries
...
- `missing_source_trace`: a slide has no nonblank source ids, or a source id list mixes real ids with blank entries.
