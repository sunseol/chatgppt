...
- `regeneration_input_lineage_mismatch` blocks a candidate when the regenerated background provenance does not cite the approved original background artifact id as canonical input lineage.
