...
- `missing_image_billing_confirmation`: image generation lacks visible Codex OAuth image usage confirmation, `apiKeyRequired: false`, or persisted confirmation evidence.
