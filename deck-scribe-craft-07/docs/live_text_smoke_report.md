...
| authenticated health turn                | pass    | `account/read` confirmed ChatGPT auth, then `thread/start` and `turn/start` produced completed thread/turn ids; the local evaluator now rejects blank or non-canonical completed health turns before they can count as authenticated evidence.                                                                                                                                                                                                                                                                                                                                                                      |
