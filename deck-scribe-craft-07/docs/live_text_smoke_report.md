...
- `bun test src/lib/live-text-smoke-gate.test.ts` covers the full text smoke bundle contract, mock/fixture and missing-turn rejection, and the requirement for a completed live Codex production post-resume next turn.
