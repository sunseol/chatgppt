...
- `insufficient_live_sources`: fewer than three distinct valid source URLs are present after placeholder, reserved documentation, local, and private-network hosts are excluded.
