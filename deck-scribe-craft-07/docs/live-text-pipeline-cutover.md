...
- `src/lib/live-text-pipeline-artifact-identity.test.ts` rejects Design/System or Layout evidence that reuses an earlier text artifact or turn id with whitespace padding.
