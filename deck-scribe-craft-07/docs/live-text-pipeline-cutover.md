...
- Deck Plan, Design System, and Layout IR must also persist as separate artifact ids; `shared_live_artifact` blocks any reused Plan/Design/Layout artifact id.
